...
<div class="highlight">$$\text{speed} = \frac{\text{distance}}{\text{time}}$$</div>
...
<div class="highlight">$$\text{velocity} = \frac{\text{displacement}}{\text{time}}$$</div>
...
<div class="highlight">$$\text{acceleration} = \frac{\Delta\text{velocity}}{time}$$</div>
...
<div class="highlight">An object will remain at rest or in uniform
...
<div class="highlight">$$\text{force} = \text{mass} \times \text{acceleration}$$
$$F = ma$$</div>
...
<div class="highlight">1 N = 1 kg m<sup>-2</sup>.</div>

Newton's third law of motion
----------------------------

<div class="highlight">If an object A exerts a force on an object B,
